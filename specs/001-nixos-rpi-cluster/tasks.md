...
- [ ] T055 [P] [US4] Create `modules/cluster/prompt.nix`: generic cluster-tier PS1 mechanism (no cluster-specific glyph fallback options at this tier — those belong in the cluster's own scope, e.g. HLC sets `hlc.prompt.glyph`). Define option:
...
- [ ] T065 [US4] Update `modules/cluster/hlc/default.nix`:
